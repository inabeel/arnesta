...
This mechanism has been integrated into Bitcore-Node-Arnesta which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Arnesta/insight-api-Arnesta#web-socket-api](https://github.com/Arnesta/insight-api-Arnesta#web-socket-api)
* API: [https://github.com/Arnesta/insight-api-Arnesta#swifttx-transactions](https://github.com/Arnesta/insight-api-Arnesta#swifttx-transactions)
...
By default, the Arnesta Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Arnesta Core daemon:
