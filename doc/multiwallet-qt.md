...
In order to support loading of multiple wallets in Arnesta-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Arnesta.cpp.
...
Changes to Arnesta.cpp
----------------------
Arnesta.cpp is the entry point into Arnesta-qt, and as such, will require some minor modifications to provide hooks for
