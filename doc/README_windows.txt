...
Intro
-----
Arnesta (ANR) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Arnesta utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run Arnesta-qt.exe.

Arnesta Core is the original Arnesta client and it builds the backbone of the network.
However, it downloads and stores the entire history of Arnesta transactions;
