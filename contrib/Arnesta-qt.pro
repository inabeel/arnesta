...
RESOURCES += src/qt/Arnesta.qrc src/qt/Arnesta_locale.qrc

TRANSLATIONS += src/qt/locale/Arnesta_bg.ts \
                src/qt/locale/Arnesta_de.ts \
                src/qt/locale/Arnesta_en.ts \
                src/qt/locale/Arnesta_es.ts \
                src/qt/locale/Arnesta_fi.ts \
                src/qt/locale/Arnesta_fr.ts \
                src/qt/locale/Arnesta_it.ts \
                src/qt/locale/Arnesta_ja.ts \
                src/qt/locale/Arnesta_pl.ts \
                src/qt/locale/Arnesta_pt.ts \
                src/qt/locale/Arnesta_ru.ts \
                src/qt/locale/Arnesta_sk.ts \
                src/qt/locale/Arnesta_sv.ts \
                src/qt/locale/Arnesta_vi.ts \
                src/qt/locale/Arnesta_zh_CN.ts \
                src/qt/locale/Arnesta_zh_TW.ts
