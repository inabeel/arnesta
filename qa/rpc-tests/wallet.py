...
#   c) node1 mines 32 blocks, so now node 0 has 500000ANR, node 1 has 4250ANR, node2 has none.
#   d) node0 sends 601 ANR to node2, in two transactions (301 ANR, then 300 ANR).
