Contributing to Arnesta Core
==================================

The Arnesta Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Arnesta Core project, and is not to be
confused with overall Arnesta Network Protocol consensus changes.

Whether a pull request is merged into Arnesta Core rests with the project merge
...
Patches that change Arnesta consensus rules are considerably more involved than
...
Where a patch set proposes to change the Arnesta consensus, it must have been
...
The project leader is the release manager for each Arnesta Core release.
