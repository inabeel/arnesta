...
//! Arnesta RPC error codes
enum RPCErrorCode {
    //! Standard JSON-RPC 2.0 errors
    RPC_INVALID_REQUEST = -32600,
    RPC_METHOD_NOT_FOUND = -32601,
    RPC_INVALID_PANRMS = -32602,
    ...
    RPC_INVALID_PANRMETER = -8,        //! Invalid, missing or duplicate parameter
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Arnesta is not connected
