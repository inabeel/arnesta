...
/** Utility functions used by the Arnesta Qt UI.
 */
namespace GUIUtil
{
...
// Render ANR addresses in monospace font
...
// Parse "Arnesta:" URI into recipient object, return true on successful parsing
