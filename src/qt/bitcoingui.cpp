                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Arnesta Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ANR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Arnesta: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Arnesta Core"), this);
    aboutAction->setStatusTip(tr("Show information about Arnesta Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arnesta"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ANR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ANR addresses"));
    ...
    openAction->setStatusTip(tr("Open a Arnesta: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Arnesta Core help message to get a list with possible Arnesta command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Arnesta Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Arnesta network", "", count));
}
...
{
    QString strTitle = tr("Arnesta Core"); // default title
