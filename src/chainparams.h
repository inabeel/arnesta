...
// Copyright (c) 2017 The Arnesta Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOIN_CHAINPANRMS_H
#define BITCOIN_CHAINPANRMS_H
 ...
 * Arnesta system. There are three: the main network on which people trade goods
