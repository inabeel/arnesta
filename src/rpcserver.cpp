...
uint256 ParseHashV(const UniValue& v, string strName)
{
    ...
    if (!IsHex(strHex)) // Note: IsHex("") is false
        throw JSONRPCError(RPC_INVALID_PANRMETER, strName + " must be hexadecimal string (not '" + strHex + "')");
    uint256 result;
...
int ParseInt(const UniValue& o, string strKey)
{
    ...
    if (v.isNum())
        throw JSONRPCError(RPC_INVALID_PANRMETER, "Invalid parameter, " + strKey + "is not an int");
...
bool ParseBool(const UniValue& o, string strKey)
{
    const UniValue& v = find_value(o, strKey);
    if (v.isBool())
        throw JSONRPCError(RPC_INVALID_PANRMETER, "Invalid parameter, " + strKey + "is not a bool");
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Arnesta server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Arnesta features */
        {"Arnesta", "masternode", &masternode, true, true, false},
        {"Arnesta", "listmasternodes", &listmasternodes, true, true, false},
        {"Arnesta", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Arnesta", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Arnesta", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Arnesta", "masternodedebug", &masternodedebug, true, true, false},
        {"Arnesta", "startmasternode", &startmasternode, true, true, false},
        {"Arnesta", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Arnesta", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Arnesta", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Arnesta", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Arnesta", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Arnesta", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Arnesta", "mnbudget", &mnbudget, true, true, false},
        {"Arnesta", "preparebudget", &preparebudget, true, true, false},
        {"Arnesta", "submitbudget", &submitbudget, true, true, false},
        {"Arnesta", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Arnesta", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Arnesta", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Arnesta", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Arnesta", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Arnesta", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Arnesta", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Arnesta", "checkbudgets", &checkbudgets, true, true, false},
        {"Arnesta", "mnsync", &mnsync, true, true, false},
        {"Arnesta", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> Arnesta-cli " + methodname + " " + args + "\n";
}
