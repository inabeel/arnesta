...
//
// The three macros TINYFORMAT_ARGTYPES(n), TINYFORMAT_VANRRGS(n) and
...
#define TINYFORMAT_VANRRGS(n) TINYFORMAT_VANRRGS_##n
...
cog.outl()
makeCommaSepLists('#define TINYFORMAT_VANRRGS_%(j)d %(list)s',
                  'const T%(i)d& v%(i)d')
...
#define TINYFORMAT_VANRRGS_1 const T1& v1
#define TINYFORMAT_VANRRGS_2 const T1 &v1, const T2 &v2
#define TINYFORMAT_VANRRGS_3 const T1 &v1, const T2 &v2, const T3 &v3
#define TINYFORMAT_VANRRGS_4 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4
#define TINYFORMAT_VANRRGS_5 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5
#define TINYFORMAT_VANRRGS_6 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6
#define TINYFORMAT_VANRRGS_7 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7
#define TINYFORMAT_VANRRGS_8 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8
#define TINYFORMAT_VANRRGS_9 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9
#define TINYFORMAT_VANRRGS_10 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10
#define TINYFORMAT_VANRRGS_11 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11
#define TINYFORMAT_VANRRGS_12 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11, const T12 &v12
#define TINYFORMAT_VANRRGS_13 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11, const T12 &v12, const T13 &v13
#define TINYFORMAT_VANRRGS_14 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11, const T12 &v12, const T13 &v13, const T14 &v14
#define TINYFORMAT_VANRRGS_15 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11, const T12 &v12, const T13 &v13, const T14 &v14, const T15 &v15
#define TINYFORMAT_VANRRGS_16 const T1 &v1, const T2 &v2, const T3 &v3, const T4 &v4, const T5 &v5, const T6 &v6, const T7 &v7, const T8 &v8, const T9 &v9, const T10 &v10, const T11 &v11, const T12 &v12, const T13 &v13, const T14 &v14, const T15 &v15, const T16 &v16
...
#define TINYFORMAT_MAKE_FORMAT_DETAIL(n)                                \
    ...
    void format(detail::FormatIterator& fmtIter, TINYFORMAT_VANRRGS(n)) \
    {                                                                   \
        fmtIter.accept(v1);                                             \
...
#define TINYFORMAT_MAKE_FORMAT_FUNCS(n)                                    \
                                                                           \
    template <TINYFORMAT_ARGTYPES(n)>                                      \
    void format(std::ostream& out, const char* fmt, TINYFORMAT_VANRRGS(n)) \
    {                                                                      \
        ...
        tinyformat::detail::format(fmtIter, TINYFORMAT_PASSARGS(n));       \
                                                                           ...
                                                                           \
    template <TINYFORMAT_ARGTYPES(n)>                                      \
    std::string format(const char* fmt, TINYFORMAT_VANRRGS(n))             \
    {                                                                      \
        std::ostringstream oss;                                            \
        ...
        return oss.str();                                                  \
                                                                           ...
                                                                           \
    template <TINYFORMAT_ARGTYPES(n)>                                      \
    std::string format(const std::string& fmt, TINYFORMAT_VANRRGS(n))      \
    {                                                                      \
        std::ostringstream oss;                                            \
        ...
        return oss.str();                                                  \
                                                                           ...
                                                                           \
    template <TINYFORMAT_ARGTYPES(n)>                                      \
    void printf(const char* fmt, TINYFORMAT_VANRRGS(n))                    \
    {                                                                      \
...
#define TINYFORMAT_WRAP_FORMAT_N(n, returnType, funcName, funcDeclSuffix,  \
    ...
    returnType funcName(TINYFORMAT_WRAP_FORMAT_EXTRA_ARGS const char* fmt, \
        TINYFORMAT_VANRRGS(n)) funcDeclSuffix                              \
    {                                                                      \
        bodyPrefix                                                         \
