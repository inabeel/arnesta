...
// Copyright (c) 2018 The Arnesta developers
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "2018 news : Arnesta took over the galaxy";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1530819563;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22110364;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000a43ec6b7ecd3fc9005f619b1c7d833bc9248fc2a3805ee6906ee11c1412"));
        assert(genesis.hashMerkleRoot == uint256("0xa8c0d2c05cf74ff73795d0af813d1df47897cbe72115c3d5bc7ec4b3dbaf1acf"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("104.238.130.229", "104.238.130.229"));
        vSeeds.push_back(CDNSSeedData("45.76.128.175", "45.76.128.175"));
        vSeeds.push_back(CDNSSeedData("149.28.42.91", "149.28.42.91"));
        vSeeds.push_back(CDNSSeedData("8.9.37.201", "8.9.37.201"));
        ...
        // Arnesta BIP44 coin type is '222' (0x800000de)
